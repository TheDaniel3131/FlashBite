    ...
    <>
      ...
      <section className="flex flex-col text-center items-center my-8">
        ...
        <div className="flex p-6 gap-16 items-center text-right text-xl">
          <Image src="/about_us.png" width={250} height={250} alt="Flashbite Story" className="text-center py-2 mb-5" />
      ...
      <footer className="border-t-2 p-10 text-center text-slate-500">
