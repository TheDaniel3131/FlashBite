    ...
    <>  
      ...
      <section className="py-20 text-center">
        ...
        <div className="text-slate-600 text-xl mt-10">
          ...
          Join the growing community of satisfied FlashBites customers and experience the convenience and joy of ordering food with just a few taps on your phone. Browser through the FlashBites website and our mobile application now!
        </div>
      </section>
    </>
  )
