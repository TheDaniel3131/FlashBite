    ...
    return(
        <>
            <section className="grid grid-cols-2 mt-12">
                <div className="py-12">
                    <h1 className="mt-5 py-5 text-6xl font-bold">Welcome to FlashBite! No. 1 Food App In Malaysia.</h1>  
                    <p className="py-5 tracking-widest text-sm text-gray-500">Order Now To Get Your Foods Fast!</p>
